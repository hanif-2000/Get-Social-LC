...
// 3. Add Picture API -
export const AddPicture = (body, userID, onResponse, onError) => {
  axios({
    method: "POST",
    url: `http://122.160.74.251:8025/add-picture/${userID}/`,
    data: body,
    headers: {
      "Content-Type": "multipart/form-data",
    },
...
// 9. get Rooms API -
export const getRoomApi = (onResponse, onError) => {
  axios({
    method: "GET",
    url: `${BASE_URL}room/`,
    headers: {
...
export const updateBiography = (body, userID, onResponse, onError) => {
  axios({
    method: "PUT",
    url: `${BASE_URL}add-biography/${userID}/`,
    data: body,
...
export const updatePicture = (body, userID, onResponse, onError) => {
  axios({
    method: "PUT",
    url: `http://122.160.74.251:8025/add-picture/${userID}/`,
    data: body,
...
export const updateUserName = (body, userID, onResponse, onError) => {
  axios({
    method: "PUT",
    url: `http://122.160.74.251:8025/add-name/${userID}/`,
    data: body,
    headers: {
      "Content-Type": "multipart/form-data",
    },
...
export const editUniversity = (body, userID, onResponse, onError) => {
  axios({
    method: "PUT",
    url: `http://122.160.74.251:8025/add-university/${userID}/`,
    data: body,
    headers: {
      "Content-Type": "multipart/form-data",
    },
